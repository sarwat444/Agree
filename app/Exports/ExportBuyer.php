...
class ExportBuyer implements FromCollection , WithHeadings,WithEvents
{
    ...
    */
    ...
    {
        $userToExport=Buyers::whereId($this->id)->select(['full_name','company_name','email','internationalNumber','countryCode','website'])->get();
        $Data=Buyers::whereId($this->id)->with(['BuyerAddressData','BuyersInterestsData'])->first();
