            ...
            <div class="card mb-0">
                <div class="card-body">
                    <a href="#" class="brand-logo">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="351" height="82.526" viewBox="0 0 351 82.526">
                            <defs>
...
{{--                        <h2 class="brand-text text-primary ms-1">Atlas</h2>--}}
                    </a>

                    <h4 class="card-title mb-1">Welcome to Atlas Admin Panel! 👋</h4>
                    <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

                    <form class="auth-login-form mt-2" method="POST" action="{{ route('loginProcess') }}">
                        @csrf
                        <div class="mb-1">
