            ...
            <div id="content" class="col-sm-12">
                ...
                @if(session()->has('supplier_success'))
                    ...
                    <div class="account-border">
                        <div class="row">
                            <form action="{{url('ResetPassword/verifyTheResetCode')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="col-sm-6 customer-signup">
                                    <div class="well">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label " for="code">Verfication Code</label>
                                            <input type="text" name="code" value="" id="code" class="form-control" />
                                        </div>
                                        <button  class="btn btn-primary" type="submit"> Verifay Email</button>
                                    </div>
