...
<head>
    ...
    <!-- Bootstrap Css -->
    <link href="{{asset(ASSET_URL_PUBLIC.'assets/admin/css/bootstrap.min.css')}}" id="bootstrap-style" rel="stylesheet" type="text/css" />
    <!-- Icons Css -->
    <link href="{{asset(ASSET_URL_PUBLIC.'assets/admin/css/icons.min.css')}}" rel="stylesheet" type="text/css" />
    <!-- App Css-->
    <link href="{{asset(ASSET_URL_PUBLIC.'assets/admin/css/app.min.css')}}" id="app-style" rel="stylesheet" type="text/css" />
